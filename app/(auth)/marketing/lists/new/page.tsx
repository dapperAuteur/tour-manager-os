...
export const metadata: Metadata = { title: 'New Email List', robots: { index: false } }
...
export default async function NewListPage() {
  ...
  return (
    <main id="main-content" className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
      ...
      <h1 className="mb-6 text-2xl font-bold">Create Email List</h1>
      <div className="rounded-xl border border-border-default bg-surface-raised p-6">
        <NewListForm orgId={orgMembership.org_id} />
      </div>
    </main>
  )
}
